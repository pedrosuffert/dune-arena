...
control InferenceModel(
    ...
    action SetCode1(bit<26> code0) {
        codewords.codeword0_1 = code0;
    }
    action SetCode2(bit<5> code0) {
    ...
    Features_t features;
    // FEATURES: ['dstport', 'srcport', 'ip.len', 'tcp.window_size_value', 'Max Packet Length']
    table TableFeature0 {
    ...
    table TableFeature4 {
        key = { statefull_features.max_length: range @name("feature4"); }
