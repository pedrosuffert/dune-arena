...
# List of registers
registers = ['Ingress.reg_flow_ID','Ingress.reg_time_last_pkt','Ingress.reg_pkt_count', 'Ingress.reg_classified_flag_model1', 'Ingress.reg_classified_flag_model2']
...
while True:
    try:
        digest = interface.digest_get(timeout=20000)
    except:
        f = open("x.txt", "a")
        f.write('---- \n')
        f.close()
    ...
    if digest_type == 1:
        ...
        keys_reg = {'Ingress.reg_flow_ID': [], 'Ingress.reg_time_last_pkt': [],
                    ...
                    'Ingress.reg_classified_flag_model2': []}
