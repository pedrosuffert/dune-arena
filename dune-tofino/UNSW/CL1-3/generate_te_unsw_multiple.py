...
clf_F = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL1-3/unsw_ClID1_N3_T1_F5_L437_With_Others.sav')
RF_models.append(clf_F)
clf_S = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL1-3/unsw_ClID3_N4_T1_F6_L85_With_Others.sav')
...
with open("te_unsw_jewel_1_5_437_N3_1_6_85_N4.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.unsw_jewel_1_5_437_N3_1_6_85_N4.pipe\n", file=entries_file)
