    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    // FEATURES:  ['tcp.hdr_len' 'srcport' 'udp.length' 'ip.ttl' 'dstport' 'tcp.window_size_value']
    ...
    apply {
            ...
            if (hdr.notify.is_flow_classified == 1){
                ...
                if (meta.pkt_count < 5){
                    ...
                    if (meta.pkt_count < 4){
                        ...
                        // If the packet classified as Others in the first model
                        if (meta.class_model1 == 20){ // OTHERS
                            set_final_class(meta.class1);
                        }
                        else{  // ONE OF THE CLASSES
        ...
        if (meta.f_action == 22) {
            ...
            ipv4_forward(4); // If the flow classified as Others, forward it to  the downstream switches.
        }
    } //END OF APPLY
