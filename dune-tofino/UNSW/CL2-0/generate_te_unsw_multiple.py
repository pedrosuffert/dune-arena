...
clf_F = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL2-0/FINAL_unsw_ClID2_N3_T3_F3_L41_With_Others.sav')
RF_models.append(clf_F)
clf_S = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL2-0/unsw_ClID0_N2_T1_F6_L481_With_Others.sav')
...
with open("te_unsw_jewel_3_3_41_N3_1_6_481_N2.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.unsw_jewel_3_3_41_N3_1_6_481_N2.pipe\n", file=entries_file)
    clear_tables = """
