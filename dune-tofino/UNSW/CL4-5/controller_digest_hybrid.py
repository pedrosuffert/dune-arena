...
# List of registers
registers = ['Ingress.reg_flow_ID','Ingress.reg_time_last_pkt','Ingress.reg_pkt_count', 'Ingress.reg_classified_flag', 'Ingress.reg_flow_iat_max', 'Ingress.reg_flow_duration']
...
while True:
    ...
    if digest_type == 1:
        ...
        keys_reg = {'Ingress.reg_flow_ID': [], 'Ingress.reg_time_last_pkt': [],
                    ...
                    'Ingress.reg_flow_iat_max': [], 'Ingress.reg_flow_duration': []}
