...
clf_F = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL4-5/unsw_ClID4_N3_T1_F7_L217_With_Others.sav')
RF_models.append(clf_F)
clf_S = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/UNSW/SPP/6CL/CL4-5/unsw_ClID5_N3_T1_F5_L129_With_Others.sav')
...
with open("te_unsw_jewel_1_7_217_N3_1_5_129_N3.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.te_unsw_jewel_1_7_217_N3_1_5_129_N3.pipe\n", file=entries_file)
