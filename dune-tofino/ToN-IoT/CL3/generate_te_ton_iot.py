...
clf = pd.read_pickle('ToN_IoT_ClID3_T1_F12_L129_N3_With_Others.sav')
...
with open("te_ton_jewel_1_12_129_N3.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.ton_jewel_1_12_129_N3.pipe\n", file=entries_file)
