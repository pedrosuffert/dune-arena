...
clf = pd.read_pickle('/home/michele/distributed_in_band/INFOCOM2025/ToN-IoT/SPP/4CLUSTER/CL1/ToN_IoT_ClID1_T1_F5_L41_N2_With_Others.sav')
## list the feature names
feature_names = clf.feature_names_in_
print(feature_names)
# ['Destination Port', 'Max Packet Length', 'Packet Length Mean', 'Packet Length Total']
...
with open("te_ton_jewel_1_5_41_N2.py", "w") as entries_file:

    print("from netaddr import IPAddress\n", file=entries_file)

    print("p4 = bfrt.ton_jewel_1_5_41_N2.py.pipe\n", file=entries_file)
...
"""
    ...
    # flow_id_info = flow_id_info[flow_id_info['flow.id'].drop_duplicates()]
    flow_id_info = flow_id_info.drop_duplicates(subset=['Flow ID'])
    # flow_id_info = flow_id_info[flow_id_info['flow.id'] != '0.0.0.0 255.255.255.255 68 67 17']
